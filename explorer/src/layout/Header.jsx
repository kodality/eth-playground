...
class Header extends React.Component {
    ...
    componentDidMount() {
        if (config.chainName) {
            this.setState({chainName: config.chainName})
        } else {
            ...
            <header>
                ...
                <div className="header-block-right">
                    ...
                    <h1 className="link-name">
                        &nbsp;<span
                        className={this.state.chainName ? 'chain-name' : 'no-display'}>{this.state.chainName} blockchain explorer</span>
                    </h1>
                    ...
                    <div className="item-search">
                        ...
                        <form onSubmit={this.doSearch}>
                            ...
                            }} className="cancel-search glyphicon glyphicon-remove-circle" aria-hidden="true"></span>

                            <span
                                className={this.state.noresult ? 'search-no-results alert alert-danger' : 'no-display'}>no result found</span>
